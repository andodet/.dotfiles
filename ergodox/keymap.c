...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    KC_LCTL,        KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                                                         KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_MINUS,
    KC_LSFT,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_TRANSPARENT,                               KC_TRANSPARENT, KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_SFT,
  ...
  [2] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_EXLM,        KC_AT,          KC_LCBR,        KC_RCBR,        KC_PIPE,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_UP,          KC_7,           KC_PGUP,        KC_9,           KC_ASTR,        KC_F12,
